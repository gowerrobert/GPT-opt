...
class AttnPDAdamW(Optimizer):
    ...
    def __init__(
        ...
        print(
            ...
            f"qk_lr_scale={qk_lr_scale}, max_norm_tr={max_norm_tr}, pdhg_iters={pdhg_max_iter}, {warm_start=}, {lsqr_max_iter=}"
            f"\n    momentum={momentum}, diag_scaling={diag_scaling}, {pd_type=}, {reflected_halpern=}, {enable_restart=}"
        )
    ...
    def step(self, closure=None, ):
        ...
        for group in self.param_groups:
            ...
            for p in group["params"]:   
                ...
                if momentum: # if to apply kq-max update on the momentum or raw gradient
                    buf1 = state["moment1"]
                    buf2 = state["moment2"]
